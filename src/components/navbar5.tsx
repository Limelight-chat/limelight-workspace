            ...
            <div className="mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
                <nav className="flex items-center justify-between relative">
                    ...
                    >
                        <NavigationMenuList className="gap-2">
                            <NavigationMenuItem>
                                <NavigationMenuLink
                                    href={consumerHref}
                                    className={navigationMenuTriggerStyle() + " bg-transparent text-[#a3a3a3] hover:bg-transparent hover:text-white focus:bg-transparent focus:text-white data-[active]:bg-transparent data-[state=open]:bg-transparent"}
                                >
                                    {consumerLabel}
                                </NavigationMenuLink>
                            </NavigationMenuItem>
                            ...
                            <NavigationMenuItem>
                                <NavigationMenuTrigger className="bg-transparent text-[#a3a3a3] hover:bg-transparent hover:text-white focus:bg-transparent focus:text-white data-[active]:bg-transparent data-[state=open]:bg-transparent">Resources</NavigationMenuTrigger>
                                    ...
                                    <div className="grid w-[600px] grid-cols-2 p-3">
                                        {features.map((feature, index) => (
                                            <NavigationMenuLink
                                                href={feature.href}
                                                key={index}
                                                className="hover:bg-[#2f2f2f] rounded-md p-3 transition-colors block"
                                            >
                    ...
                    <div className="hidden items-center gap-4 lg:flex">
                        <Button variant="ghost" className="text-[#f5f5f0] hover:bg-[#2f2f2f] hover:text-white">Log In</Button>
                        ...
                        <SheetContent side="top" className="max-h-screen overflow-auto bg-[#171616] border-b border-[#2e2d2d] text-[#f5f5f0]">
                            ...
                            <div className="flex flex-col p-4">
                                <div className="flex flex-col gap-6">
                                    ...
                                    <a href="/pricing" className="font-medium text-[#a3a3a3] hover:text-white">
                                        Pricing
                                    </a>
                                    <a href="/contact" className="font-medium text-[#a3a3a3] hover:text-white">
                                        Contact Us
                                    </a>
                                </div>
                                ...
                                <div className="mt-6 flex flex-col gap-4">
                                    <Button variant="ghost" className="text-[#f5f5f0] hover:bg-[#2f2f2f] hover:text-white justify-start px-0">Log In</Button>
